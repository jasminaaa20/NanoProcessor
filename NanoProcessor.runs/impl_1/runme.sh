...
HD_PWD='C:/Users/jakma/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano_Processor_7_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nano_Processor_7_seg.tcl -notrace
