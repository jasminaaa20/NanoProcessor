...
HD_PWD='C:/Users/jakma/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano_Processor_7_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nano_Processor_7_seg.tcl
